 ...
 * @ac: The command-line number arguments.
 * @av: The command-line  array arguments.
 *
 * Return: 0 on success.
 */
...
/**
 * wspace - The character space or tab check
...
/**
 * read_command - The user input from stdin read.
 *
 * Return: The Pointer to the input command string.
 */
...
/**
 * handle_sigint - The handler for SIGINT (Ctrl+C).
