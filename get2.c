 ...
 * The new alias or env
 * @name: The(alias or env) name
 * @value: The(alias or env) value
 *
...
/**
 * set_env - The environment variable sets
 *
...
/**
 * _setenv - The env variables names compares
...
/**
 * _unsetenv - The environment variable deletes
 *
