...
/**
* struct Node - The linked singly list
 ...
 * @node: The linked list node to be added
 */
...
/**
 * struct alias_s - The structure representing represent
 * @name: The alias name
 * @value: The alias value
 * @next: The pointer to the linked list alias
 */
